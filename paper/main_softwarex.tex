...
\begin{tabular}{|l|p{5.2cm}|p{5.7cm}|}
\hline
\textbf{Nr.} & \textbf{Code metadata description} & \textbf{Metadata} \\ \hline
C1 & Current code version & v0.1.0 \\ \hline
C2 & Permanent link to code/repository used for this code version & \texttt{https://github.com/tkucukdeniz2/curricumap} (release \texttt{v0.1.0}) \\ \hline
...
MIT license (Table~\ref{tab:codemeta}). No personal data are distributed: the
